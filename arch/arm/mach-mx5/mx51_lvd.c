...
/* IOMUX to GPIO */
#define LVD_SD_MMC_SD       (0*32 + 0)  /* GPIO_1_0 */
#define LVD_SD1_WP          (0*32 + 1)  /* GPIO_1_1 */
#define LVD_PWM1_OUT        (0*32 + 2)  /* GPIO_1_2 */
#define LVD_SYS_ON_OFF_CTL  (0*32 + 3)  /* GPIO_1_3 */
#define LVD_WDOG_B          (0*32 + 4)  /* GPIO_1_4 */
#define LVD_26M_OSC_EN      (0*32 + 5)  /* GPIO_1_5 */
#define LVD_LOW_P_EN		  (0*32 + 6)  /* GPIO_1_6 */
#define LVD_INT_FROM_PMIC   (0*32 + 8)  /* GPIO_1_8 */
...
#define LVD_AC_IN           (1*32 + 1)  /* GPIO_2_1 */
#define LVD_CHG_OK          (1*32 + 2)  /* GPIO_2_2 */
#define LVD_RST_USB_PHY_B   (1*32 + 5)  /* GPIO_2_5 */
#define LVD_EIM_A16		   (1*32 + 10) /* GPIO_2_10 */
#define LVD_EIM_A17		   (1*32 + 11) /* GPIO_2_10 */
#define LVD_LID_CLOSE_B     (1*32 + 18) /* GPIO_2_18 */
#define LVD_LOW_BAT_WAKEUP  (1*32 + 19) /* GPIO_2_19 */
#define LVD_SYS_ON_OFF_REQ  (1*32 + 21) /* GPIO_2_21 */
#define LVD_G_SENSOR_INT    (1*32 + 22) /* GPIO_2_22 */
#define LVD_COMPASS_INT     (1*32 + 25) /* GPIO_2_25 */

#define LVD_LCD_PWR_ON		(2*32 + 0)  /* GPIO_3_0 */
#define LVD_LCD_STBYB		(2*32 + 1)  /* GPIO_3_1 */
#define LVD_TOUCH_REST      (2*32 + 3)  /* GPIO_3_3 */
#define LVD_MIC_S           (2*32 + 5)  /* GPIO_3_5 */ 
#define LVD_CSI1_PWDN       (2*32 + 6)  /* GPIO_3_6 */
#define LVD_RST_USB_HUB_B   (2*32 + 7)  /* GPIO_3_7 */
#define LVD_LVDS_SHTDN      (2*32 + 8)  /* GPIO_3_8 */
#define LVD_VCAM_EN         (2*32 + 13) /* GPIO_3_13 */
#define LVD_AMP_SHUT        (2*32 + 29) /* GPIO_3_29 */
#define LVD_HPHONE_DET      (2*32 + 30) /* GPIO_3_30 */
#define LVD_VIBRATOR_ON     (2*32 + 31) /* GPIO_3_31 */

#define LVD_EN_WIFI_PWR      (3*32 + 2)  /* GPIO_4_2 */
#define LVD_BT_RST           (3*32 + 3)  /* GPIO_4_3 */
#define LVD_WL_RST           (3*32 + 4)  /* GPIO_4_4 */
#define LVD_BT_WAKEUP_HOST   (3*32 + 5)  /* GPIO_4_5 */
#define LVD_WLAN_WAKEUP_HOST (3*32 + 6)  /* GPIO_4_6 */
#define LVD_TOUCH_EN         (3*32 + 8)  /* GPIO_4_8 */
#define LVD_LVDS_RSVD        (3*32 + 9)  /* GPIO_4_9 */
#define LVD_3G_SIM_DET       (3*32 + 11) /* GPIO_4_11 */
#define LVD_3G_PWR_EN      (3*32 + 12) /* GPIO_4_12 */
#define LVD_3G_EN			 (3*32 + 13) /* GPIO_4_13 */
#define LVD_CSP1_SS0_GPIO    (3*32 + 24) /* GPIO_4_24 */

extern int __init mx51_lvd_init_mc13892(void);
...
#ifdef CONFIG_PM_CHECK
static struct gpio_check lvd_gpio_check[] = {
	{LVD_SD_MMC_SD, 1},
	{LVD_SD1_WP, 0},
	{LVD_SYS_ON_OFF_CTL, 1},
	{LVD_WDOG_B, 1},
	{LVD_INT_FROM_PMIC, 1},
	{LVD_TOUCH_INT, 1},
	{LVD_3G_RST, 1},
	{LVD_GPS_RST, 1},
	{LVD_GPS_PWR_ON, 1},
	{LVD_HOST_WAKEUP_WLAN, 1},
	{LVD_HOST_WAKEUP_BT, 1},
	{LVD_AC_IN, 1},
	{LVD_CHG_OK, 1},
	{LVD_RST_USB_PHY_B, 1},
	{LVD_EIM_A16, 1},
	{LVD_EIM_A17, 1},
	{LVD_LID_CLOSE_B, 1},
	{LVD_LOW_BAT_WAKEUP, 1},
	{LVD_SYS_ON_OFF_REQ, 1},
	{LVD_G_SENSOR_INT, 1},
	{LVD_COMPASS_INT, 1},
	{LVD_LCD_PWR_ON, 1},
	{LVD_LCD_STBYB, 1},
	...
	{LVD_BT_RST, 1},
	{LVD_WL_RST, 1},
	{LVD_BT_WAKEUP_HOST, 1},
	{LVD_WLAN_WAKEUP_HOST, 1},
	{LVD_TOUCH_EN, 1},
	{LVD_LVDS_RSVD, 1},
	{LVD_3G_SIM_DET, 1},
	{LVD_3G_EN, 1},
...
static struct dvfs_wp *mx51_lvd_get_dvfs_core_table(int *wp)
{
	*wp = ARRAY_SIZE(dvfs_core_setpoint);
	return dvfs_core_setpoint;
}

struct cpu_wp *mx51_lvd_get_cpu_wp(int *wp)
{
	*wp = num_cpu_wp;
	return cpu_wp_auto;
}

void mx51_lvd_set_num_cpu_wp(int num)
{
	num_cpu_wp = num;
	return;
}
...
static void mx51_lvd_gpio_spi_chipselect_active(int cspi_mode, int status,
					     int chipselect)
{
	switch (cspi_mode) {
	case 1:
...
static void mx51_lvd_gpio_spi_chipselect_inactive(int cspi_mode, int status,
					       int chipselect)
{
	switch (cspi_mode) {
	case 1:
...
static struct mxc_spi_master mxcspi1_data = {
	.maxchipselect = 4,
	.spi_version = 23,
	.chipselect_active = mx51_lvd_gpio_spi_chipselect_active,
	.chipselect_inactive = mx51_lvd_gpio_spi_chipselect_inactive,
};
...
static struct fb_videomode video_modes[] = {
	{
	 /* 1024x600 @ 60 Hz , pixel clk @ 45.068MHz / 22189 ps */
	 "EJ080NA04BPRE", 52, 1024, 768, 22189, 40, 45, 4, 5, 5, 1,
...
{
	printk(KERN_DEBUG "lvd: lcd suspend\n");

	/* PULL LVDS shutdown to LOW */
	gpio_set_value(LVD_LVDS_SHTDN, 0);
	//msleep(10);

	/* PULL LCD POWER ON to LOW to shut down LCD */
	gpio_set_value(LVD_LCD_STBYB, 0);
	msleep(100);
	gpio_set_value(LVD_LCD_PWR_ON, 0);
	msleep(20);
}

static void lcd_pre_resume(void)
{
	//printk(KERN_INFO "lvd: lcd pre resume\n");

	/* PULL LCD POWER ON to HIGH to Light LCD on */
	gpio_set_value(LVD_LCD_STBYB, 1);
	gpio_set_value(LVD_LCD_PWR_ON, 1);

	/* delay 100ms after LCD power on */
	msleep(100);
	gpio_set_value(LVD_LVDS_SHTDN, 1);
	msleep(10);
}
...
{
    gpio_set_value(LVD_CSI1_PWDN, pwdn & 0x01);
}
...
static int lvd_chg_is_cable_in(void);
static int lvd_is_charge_ok(void);
...
static struct battery_platform_data bq27210_plat_data = {
	...
	.is_charging_full = lvd_is_charge_ok,
...
struct kxtf9_platform_data lvd_kxtf9_data = {
	.min_interval   = 1,
	.poll_interval  = 10,
...
static struct pixcir_touchkey pixcir_touchkey_800_600_map[] = {
	{KEY_BACK, 0x1, 880, 125},
	{KEY_HOME, 0x2, 880, 300},
	{KEY_MENU, 0x4, 880, 480},
	{-1, -1, -1, -1},
};

static struct pixcir_touch_pdata pixcir_800_600_pdata = {
	.x_min = 0,
	.x_max = 800,
	.y_min = 0,
	.y_max = 600,

	.gpio_int = LVD_TOUCH_INT,
	.gpio_reset = LVD_TOUCH_REST,
	.pixcir_touchkey_map = pixcir_touchkey_800_600_map,
};

static struct pixcir_touchkey pixcir_touchkey_map[] = {
	{KEY_BACK, 0x1, 1120, 150},
	{KEY_HOME, 0x2, 1120, 385},
	{KEY_MENU, 0x4, 1120, 620},
	{-1, -1, -1, -1},
};

static struct pixcir_touch_pdata pixcir_pdata = {
	.x_min = 0,
	.x_max = 1024,
	.y_min = 0,
	.y_max = 768,
	...
	.gpio_int = LVD_TOUCH_INT,
	.gpio_reset = LVD_TOUCH_REST,
	.pixcir_touchkey_map = pixcir_touchkey_map,
};

static struct pixcir_touch_pdata *  pixcir_callback(int version)
{
	if (version == 255)
		return &pixcir_800_600_pdata;
	else
		return &pixcir_pdata;
}

static struct pixcir_callback_pdata pixcir_callback_pdata = {
	.callback = pixcir_callback,
};
...
static unsigned int sdhc_get_card_det_status(struct device *dev)
{
	...
	if (to_platform_device(dev)->id == 0) {
		ret = gpio_get_value(LVD_SD_MMC_SD);
		return ret;
...
static int mx51_wifi_power(int on)
{
	...
	if(on) {
		gpio_set_value(LVD_WL_RST, 1);
	} else {
		gpio_set_value(LVD_WL_RST, 0);
	}
	return 0;
}
...
{
	gpio_set_value(LVD_MIC_S, enable ? 0 : 1);
	return 0;
}

static int mxc_sgtl5000_amp_enable(int enable)
{
	gpio_set_value(LVD_AMP_SHUT, enable);
	return 0;
}
...
{
	return (gpio_get_value(LVD_HPHONE_DET) == 1);
}
...
static int lvd_chg_is_cable_in(void)
{
	return gpio_get_value(LVD_AC_IN) ? 0 : 1;
}

static int lvd_is_charge_ok(void)
{
	return gpio_get_value(LVD_CHG_OK) ? 0 : 1;
}

static unsigned int lvd_get_bat_capacity(void)
{
	return 50;
}
...
static unsigned int lvd_get_bat_voltage(void)
{
...
static unsigned int lvd_get_bat_current(void)
{
	unsigned short result[8];
...
static struct mc13892_power_supply_pdata mc13892_psy_data = {
	.is_cable_in = lvd_chg_is_cable_in,
	.is_charge_ok = lvd_is_charge_ok,
	.get_bat_capacity = lvd_get_bat_capacity,
	.get_bat_voltage = lvd_get_bat_voltage,
	.get_bat_current = lvd_get_bat_current,
};
...
static int bluetooth_power(int on)
{
	...
	gpio_request(LVD_BT_RST, "bt_reset");
	if (on) {
		gpio_direction_output(LVD_BT_RST, 1);
	} else {
		gpio_direction_output(LVD_BT_RST, 0);
	}
	gpio_free(LVD_BT_RST);
...
static struct resource mx51_bluesleep_resources[] = {
	[0] = {
		.name  = "gpio_host_wake",
		.start = LVD_BT_WAKEUP_HOST,
		.end   = LVD_BT_WAKEUP_HOST,
		.flags = IORESOURCE_IO,
	},

	[1] = {
		.name  = "bt_wakeup",
		.start =  LVD_HOST_WAKEUP_BT,
		.end   =  LVD_HOST_WAKEUP_BT,
		.flags = IORESOURCE_IO,
	},
...
static void mxc_power_off(void)
{
	...
	gpio_direction_output(LVD_SYS_ON_OFF_CTL, 0);
	gpio_set_value(LVD_SYS_ON_OFF_CTL, 0);
}
...
{
	return gpio_get_value(LVD_SYS_ON_OFF_REQ) ? 0 : 1;
}
...
{
	gpio_request(LVD_3G_RST, "3gmodem_reset");
	gpio_direction_output(LVD_3G_RST, 0);
	msleep(100);
	gpio_direction_output(LVD_3G_RST, 1);
	gpio_free(LVD_3G_RST);
...
{
	gpio_request(LVD_3G_PWR_EN, "3gmodem_pwr_en");
	gpio_request(LVD_3G_EN, "3gmodem_en");
	gpio_request(LVD_3G_RST, "3gmodem_reset");
	
	if (enable) {
		gpio_direction_output(LVD_3G_RST, 1);
		gpio_direction_output(LVD_3G_PWR_EN, 1);
		gpio_direction_output(LVD_3G_EN, 1);
	} else {
		gpio_direction_output(LVD_3G_PWR_EN, 0);
		gpio_direction_output(LVD_3G_EN, 0);
		gpio_direction_output(LVD_3G_RST, 0);
	}

	gpio_free(LVD_3G_PWR_EN);
	gpio_free(LVD_3G_EN);
	gpio_free(LVD_3G_RST);
...
{
	return gpio_get_value(LVD_3G_SIM_DET);
}

static struct modem_platform_data lvd_modem_platform =
{
	.sim_irq = -1,
	.wakeup_irq = -1,
	.is_sim_in = is_sim_in,
...
static struct platform_device lvd_3gmodem_device = {
	.name = "3Gmodem",
	.id = -1,
	.dev = {
		.platform_data = &lvd_modem_platform,
	},
};
...
{
	gpio_request(LVD_3G_EN, "modem off");
	gpio_direction_input(LVD_3G_EN);
	gpio_free(LVD_3G_EN);

	gpio_request(LVD_3G_SIM_DET, "sim_cd");
	gpio_direction_input(LVD_3G_SIM_DET);
	lvd_modem_platform.sim_irq = gpio_to_irq(LVD_3G_SIM_DET);

	if (platform_device_register(&lvd_3gmodem_device)) {
		pr_err("add 3G modem device failed\n");
		return;
	}
}

static void __init mx51_lvd_io_init(void)
{
	mxc_iomux_v3_setup_multiple_pads(mx51lvd_pads, ARRAY_SIZE(mx51lvd_pads));

	/* SYS_ON_OFF_CTRL */
	gpio_request(LVD_SYS_ON_OFF_CTL, "power_off");
	gpio_direction_output(LVD_SYS_ON_OFF_CTL, 1);
	gpio_set_value(LVD_SYS_ON_OFF_CTL, 1);
	
	/* SYS_ON_OFF_REQ */
	gpio_request(LVD_SYS_ON_OFF_REQ, "power_key");
	gpio_direction_input(LVD_SYS_ON_OFF_REQ);

	/* PMIC INT */
	gpio_request(LVD_INT_FROM_PMIC, "pmic_int");
	gpio_direction_input(LVD_INT_FROM_PMIC);

	/* SD1_CD SD1_WP */ 
	gpio_request(LVD_SD_MMC_SD, "sdhc1_detect");
	gpio_direction_input(LVD_SD_MMC_SD);
	gpio_request(LVD_SD1_WP, "sdhc1_wp");
	gpio_direction_input(LVD_SD1_WP);

	/* De-assert USB PHY RESETB */
	gpio_request(LVD_RST_USB_PHY_B, "usb_phy_reset");
	gpio_direction_output(LVD_RST_USB_PHY_B, 1);

	/* RST_USB_HUB_B */
	gpio_request(LVD_RST_USB_HUB_B, "rst_usb_hub");
	gpio_direction_output(LVD_RST_USB_HUB_B, 0);
	gpio_set_value(LVD_RST_USB_HUB_B, 0);
	msleep(1);
	gpio_set_value(LVD_RST_USB_HUB_B, 1);

	/* cap touch */
	gpio_request(LVD_TOUCH_INT, "touch_int");
	gpio_direction_input(LVD_TOUCH_INT);
	
	/* cap touch reset */
	gpio_request(LVD_TOUCH_REST, "touch_reset");

	/* Camera module enable */
	gpio_request(LVD_CSI1_PWDN, "camera_enable");
	gpio_direction_output(LVD_CSI1_PWDN, 0);
	gpio_set_value(LVD_CSI1_PWDN, 1);

	/* LVD_VCAM_EN */
	gpio_request(LVD_VCAM_EN, "vcam_en");
	gpio_direction_output(LVD_VCAM_EN, 1);

	/* gsensor int */
	gpio_request(LVD_G_SENSOR_INT, "gsensor_int");
	gpio_direction_input(LVD_G_SENSOR_INT);

	/* WL_RST */
	gpio_request(LVD_WL_RST, "wl_rst");
	gpio_direction_output(LVD_WL_RST, 0);

	/* compass int */
	gpio_request(LVD_COMPASS_INT, "compass_int");
	gpio_direction_input(LVD_COMPASS_INT);

	/* VIBRATOR ON*/
	gpio_request(LVD_VIBRATOR_ON, "vibrator_on"); /* driver to low or high ?*/
	gpio_direction_output(LVD_VIBRATOR_ON, 0);

	/* Charger detect */
	gpio_request(LVD_AC_IN, "charger_det");
	gpio_direction_input(LVD_AC_IN);

	/* low battery wake up */
	gpio_request(LVD_LOW_BAT_WAKEUP, "low_bat_wakeup");
	gpio_direction_input(LVD_LOW_BAT_WAKEUP);

	/* Charger charge status */
	gpio_request(LVD_CHG_OK, "charge_ok");
	gpio_direction_input(LVD_CHG_OK);

	gpio_request(LVD_EIM_A16, "eim_a16");
	gpio_direction_output(LVD_EIM_A16, 1);
	gpio_request(LVD_EIM_A17, "eim_a17");
	gpio_direction_output(LVD_EIM_A17, 1);

	/* hphone_det_b */
	gpio_request(LVD_HPHONE_DET, "hphone-det");
	gpio_direction_input(LVD_HPHONE_DET);

	/* audio hphone mic control pin */
	gpio_request(LVD_MIC_S, "hphone_mic");
	gpio_direction_output(LVD_MIC_S, 1);
	gpio_set_value(LVD_MIC_S, 0);

	/* LCD related gpio */
	gpio_request(LVD_LCD_STBYB, "lcd_standby");
	gpio_direction_output(LVD_LCD_STBYB, 1);
	gpio_request(LVD_LCD_PWR_ON, "lcd_power_on");
	gpio_direction_output(LVD_LCD_PWR_ON, 1);

	/* LVDS related gpio */
	gpio_request(LVD_LVDS_SHTDN, "lvds_power");
	gpio_direction_output(LVD_LVDS_SHTDN, 1);
	gpio_request(LVD_LVDS_RSVD, "lvds_rsvd");
	gpio_direction_output(LVD_LVDS_RSVD, 0);

	/* LCD pwm out pin */
	gpio_request(LVD_PWM1_OUT, "pwm1_out");
	gpio_direction_output(LVD_PWM1_OUT, 0);
	...
	gpio_request(LVD_BT_WAKEUP_HOST, "bt_wakeup_host");
	gpio_direction_input(LVD_BT_WAKEUP_HOST);
	gpio_free(LVD_BT_WAKEUP_HOST);

	gpio_request(LVD_HOST_WAKEUP_BT, "bt_wakeup");
	gpio_direction_output(LVD_HOST_WAKEUP_BT, 1);
	gpio_free(LVD_HOST_WAKEUP_BT);
...
void mx51_lvd_workaround_tps65251_low_power_mode(int low_power)
{
	printk(KERN_DEBUG "LVD low power mode %d\n", low_power);
	if (low_power)
		gpio_set_value(LVD_LOW_P_EN, 1);
	else
		gpio_set_value(LVD_LOW_P_EN, 0);
}
...
#ifdef CONFIG_PM_CHECK
	register_gpio_setting(&lvd_gpio_check);
#endif
}

static void __init mx51_lvd_timer_init(void)
{
	struct clk *uart_clk;
 ...
 */
/* *INDENT-OFF* */
MACHINE_START(MX51_LVD, "Lvd Freescale MX51 Board")
