...
#define TULIP_GPS_UART2_TXD   (0*32 + 21) /* GPIO_1_21 */
...
static struct pad_desc mx51tulip_pads[] = {
	/* charger ac_in */
...
static struct bq24103_platform_data  bq24103_pdata = {
	.is_online = tulip_chg_is_cable_in,
	.irq = IOMUX_TO_IRQ_V3(TULIP_AC_IN),
};
...
static struct pixcir_i2c_ts_platform_data pixcir_data = { 
	.gpio_reset = TULIP_TOUCH_REST,
};
...
static struct i2c_board_info mxc_i2c0_board_info[] __initdata = {
	...
	//.irq  = IOMUX_TO_IRQ_V3(TULIP_G_SENSOR_INT),
	},
	{	/* compass */
	.type = "hmc5883",
	.addr = 0x1e,
	.platform_data = &hmc5883_data,
	.irq  = IOMUX_TO_IRQ_V3(TULIP_COMPASS_INT),
	}, 
...
static struct i2c_board_info mxc_i2c1_board_info[] __initdata = {
	...
	{	/* touch */
		.type = "pixcir_touch",
		.addr = 0x5c,
		.platform_data = &pixcir_data,
		.irq  = IOMUX_TO_IRQ_V3(TULIP_TOUCH_INT),
	}, 
	{   /* Camera */
		.type = "ov26xx",
		.addr = 0x30,
...
static struct resource mx51_wifi_resources[] = {
	[0] = {
		...
		.start =  IOMUX_TO_IRQ_V3(TULIP_WLAN_WAKEUP_HOST),
		.end   =  IOMUX_TO_IRQ_V3(TULIP_WLAN_WAKEUP_HOST),
...
static struct mxc_audio_platform_data sgtl5000_data = {
	...
	.src_port = 2,
	.ext_port = 3,
	.hp_irq = IOMUX_TO_IRQ_V3(TULIP_HPHONE_DET),
...
static void mxc_register_powerkey(pwrkey_callback pk_cb)
{
	...
	int irq, ret;
	irq = IOMUX_TO_IRQ_V3(TULIP_SYS_ON_OFF_REQ);
...
static void __init mxc_board_init(void)
{
	...
	/* SD card detect irqs */
	mxcsdhc1_device.resource[2].start = IOMUX_TO_IRQ_V3(TULIP_SD_MMC_SD);
	mxcsdhc1_device.resource[2].end = IOMUX_TO_IRQ_V3(TULIP_SD_MMC_SD);
