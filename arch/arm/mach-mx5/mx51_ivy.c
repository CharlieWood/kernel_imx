...
/* IOMUX to GPIO */
#define IVY_SD_MMC_SD       (0*32 + 0)  /* GPIO_1_0 */
#define IVY_SD1_WP          (0*32 + 1)  /* GPIO_1_1 */
#define IVY_PWM1_OUT        (0*32 + 2)  /* GPIO_1_2 */
#define IVY_SYS_ON_OFF_CTL  (0*32 + 3)  /* GPIO_1_3 */
#define IVY_WDOG_B          (0*32 + 4)  /* GPIO_1_4 */
#define IVY_26M_OSC_EN      (0*32 + 5)  /* GPIO_1_5 */
#define IVY_LOW_P_EN        (0*32 + 6)  /* GPIO_1_6 */
#define IVY_INT_FROM_PMIC   (0*32 + 8)  /* GPIO_1_8 */
#define IVY_TOUCH_INT       (0*32 + 9)  /* GPIO_1_9 */
#define IVY_3G_RST          (0*32 + 10) /* GPIO_1_10 */
#define IVY_GPS_RST         (0*32 + 19) /* GPIO_1_19 */
#define IVY_GPS_UART2_TXD   (0*32 + 21) /* GPIO_1_21 */
#define IVY_GPS_PWR_ON      (0*32 + 29) /* GPIO_1_29 */
#define IVY_HOST_WAKEUP_WLAN (0*32 + 30) /* GPIO_1_30 */
#define IVY_HOST_WAKEUP_BT  (0*32 + 31) /* GPIO_1_31 */

#define IVY_AC_IN           (1*32 + 1)  /* GPIO_2_1 */
#define IVY_CHG_OK          (1*32 + 2)  /* GPIO_2_2 */
#define IVY_RST_USB_PHY_B   (1*32 + 5)  /* GPIO_2_5 */
#define IVY_EIM_A16		   (1*32 + 10) /* GPIO_2_10 */
#define IVY_EIM_A17		   (1*32 + 11) /* GPIO_2_10 */
#define IVY_LID_CLOSE_B     (1*32 + 18) /* GPIO_2_18 */
#define IVY_LOW_BAT_WAKEUP  (1*32 + 19) /* GPIO_2_19 */
#define IVY_SYS_ON_OFF_REQ  (1*32 + 21) /* GPIO_2_21 */
#define IVY_G_SENSOR_INT    (1*32 + 22) /* GPIO_2_22 */
#define IVY_COMPASS_INT     (1*32 + 25) /* GPIO_2_25 */

#define IVY_LCD_PWR_ON      (2*32 + 0)  /* GPIO_3_0 */
#define IVY_LCD_STBYB       (2*32 + 1)  /* GPIO_3_1 */
#define IVY_TOUCH_REST      (2*32 + 3)  /* GPIO_3_3 */
#define IVY_MIC_S           (2*32 + 5)  /* GPIO_3_5 */ 
#define IVY_CSI1_PWDN       (2*32 + 6)  /* GPIO_3_6 */
#define IVY_RST_USB_HUB_B   (2*32 + 7)  /* GPIO_3_7 */
#define IVY_LVDS_SHTDN      (2*32 + 8)  /* GPIO_3_8 */
#define IVY_VCAM_EN         (2*32 + 13) /* GPIO_3_13 */
#define IVY_AMP_SHUT        (2*32 + 29) /* GPIO_3_29 */
#define IVY_HPHONE_DET      (2*32 + 30) /* GPIO_3_30 */
#define IVY_VIBRATOR_ON     (2*32 + 31) /* GPIO_3_31 */

#define IVY_WL_BT_PWR_ON     (3*32 + 2)  /* GPIO_4_2 */
#define IVY_BT_RST           (3*32 + 3)  /* GPIO_4_3 */
#define IVY_WL_RST           (3*32 + 4)  /* GPIO_4_4 */
#define IVY_BT_WAKEUP_HOST   (3*32 + 5)  /* GPIO_4_5 */
#define IVY_WLAN_WAKEUP_HOST (3*32 + 6)  /* GPIO_4_6 */
#define IVY_LVDS_RSVD        (3*32 + 9)  /* GPIO_4_9 */
#define IVY_3G_SIM_DET       (3*32 + 11) /* GPIO_4_11 */
#define IVY_3G_PWR_EN        (3*32 + 12) /* GPIO_4_12 */
#define IVY_3G_EN            (3*32 + 13) /* GPIO_4_13 */
#define IVY_CSP1_SS0_GPIO    (3*32 + 24) /* GPIO_4_24 */

extern int __init mx51_ivy_init_mc13892(void);
...
#ifdef CONFIG_PM_CHECK
static struct gpio_check ivy_gpio_check[] = {
	{IVY_SD_MMC_SD, 1},
	{IVY_SD1_WP, 0},
	{IVY_SYS_ON_OFF_CTL, 1},
	{IVY_WDOG_B, 1},
	{IVY_26M_OSC_EN, 1},
	{IVY_LOW_P_EN, 0},
	{IVY_INT_FROM_PMIC, 1},
	...
	{IVY_GPS_RST, 1},
	{IVY_GPS_PWR_ON, 1},
	{IVY_HOST_WAKEUP_WLAN, 1},
	{IVY_HOST_WAKEUP_BT, 1},
	{IVY_AC_IN, 1},
	{IVY_CHG_OK, 1},
	{IVY_RST_USB_PHY_B, 1},
	{IVY_EIM_A16, 1},
	{IVY_EIM_A17, 1},
	{IVY_LID_CLOSE_B, 1},
	{IVY_LOW_BAT_WAKEUP, 1},
	{IVY_SYS_ON_OFF_REQ, 1},
	{IVY_G_SENSOR_INT, 1},
	{IVY_COMPASS_INT, 1},
	{IVY_LCD_PWR_ON, 1},
	{IVY_LCD_STBYB, 1},
	...
	{IVY_BT_RST, 1},
	{IVY_WL_RST, 1},
	{IVY_BT_WAKEUP_HOST, 1},
	{IVY_WLAN_WAKEUP_HOST, 1},
	{IVY_LVDS_RSVD, 1},
	{IVY_3G_SIM_DET, 1},
	{IVY_3G_PWR_EN, 1},
	{IVY_3G_EN, 1},
...
static struct pad_desc mx51_ivy_pads[] = {
	/* charger ac_in */
...
static struct dvfs_wp *mx51_ivy_get_dvfs_core_table(int *wp)
{
	*wp = ARRAY_SIZE(dvfs_core_setpoint);
	return dvfs_core_setpoint;
}

struct cpu_wp *mx51_ivy_get_cpu_wp(int *wp)
{
	*wp = num_cpu_wp;
	return cpu_wp_auto;
}

void mx51_ivy_set_num_cpu_wp(int num)
{
	num_cpu_wp = num;
	return;
}
...
static u16 keymapping[6] = {
	KEY_HOME, KEY_MENU, KEY_BACK, KEY_VOLUMEDOWN,
	KEY_VOLUMEUP, KEY_0,
};
...
static void mx51_ivy_gpio_spi_chipselect_active(int cspi_mode, int status,
					     int chipselect)
{
	switch (cspi_mode) {
	case 1:
		...
		case 0x2:
			...
			gpio_request(IVY_CSP1_SS0_GPIO, "cspi1-gpio");
			gpio_direction_output(IVY_CSP1_SS0_GPIO, 0);
			gpio_set_value(IVY_CSP1_SS0_GPIO, 1 & (~status));
			break;
			}
		default:
			break;
...
static void mx51_ivy_gpio_spi_chipselect_inactive(int cspi_mode, int status,
					       int chipselect)
{
	switch (cspi_mode) {
	case 1:
...
static struct mxc_spi_master mxcspi1_data = {
	.maxchipselect = 4,
	.spi_version = 23,
	.chipselect_active = mx51_ivy_gpio_spi_chipselect_active,
	.chipselect_inactive = mx51_ivy_gpio_spi_chipselect_inactive,
};
...
static struct fb_videomode video_modes[] = {
	{
	 ...
	 "AT070TNA2", 60, 1024, 600, 22557, 84, 88, 8, 6, 4, 2,
...
{
	printk(KERN_DEBUG "ivy: lcd suspend\n");

	/* PULL LVDS shutdown to LOW */
	gpio_set_value(IVY_LVDS_SHTDN, 0);
	//msleep(10);

	/* PULL LCD POWER ON to LOW to shut down LCD */
	gpio_set_value(IVY_LCD_STBYB, 0);
	msleep(100);
	gpio_set_value(IVY_LCD_PWR_ON, 0);
	msleep(20);
}

static void lcd_pre_resume(void)
{
	//printk(KERN_INFO "ivy: lcd pre resume\n");

	/* PULL LCD POWER ON to HIGH to Light LCD on */
	gpio_set_value(IVY_LCD_STBYB, 1);
	gpio_set_value(IVY_LCD_PWR_ON, 1);

	/* delay 100ms after LCD power on */
	msleep(100);
	gpio_set_value(IVY_LVDS_SHTDN, 1);
	msleep(10);
}
...
static void lcd_resume(void)
{
	...
	printk(KERN_DEBUG "ivy: lcd resume\n");
	msleep(20);
...
{
	struct pad_desc pad_gpio_out = MX51_PAD_GPIO_1_2__GPIO_1_2;
	struct pad_desc pad_pwm1_out = MX51_PAD_GPIO_1_2__PWM_PWMO;

	printk(KERN_INFO "ivy: lcd blank %d\n", blank);
	if (blank) {
		/* config PWM1_OUT to gpio output low */
		mxc_iomux_v3_setup_pad(&pad_gpio_out);
		msleep(50);
	}
	else {
		msleep(50);
...
static struct mxc_fb_platform_data fb_data[] = {
	{
	 ...
	 .suspend = lcd_suspend,
	 .resume = lcd_resume,
	 .pre_suspend = lcd_pre_suspend,
	 .pre_resume = lcd_pre_resume,
	 .blank = lcd_blank,
	 },
};
...
{
    gpio_set_value(IVY_CSI1_PWDN, pwdn & 0x01);
}
...
static int ivy_chg_is_cable_in(void);
static int ivy_is_charge_ok(void);
#ifdef CONFIG_BATTERY_BQ27210
static struct battery_platform_data bq27210_plat_data = {
	.bat_voltage_of_zero_uV = 7000000,
	.is_online = ivy_chg_is_cable_in,
	.is_charging_full = ivy_is_charge_ok,
...
static struct ft5x0x_touchkey ft5x0x_touchkey_map[] = {
	{KEY_BACK, 0x1, 129, 1063},
	{KEY_HOME, 0x2, 280, 1063},
	{KEY_MENU, 0x4, 468, 1063},
	{-1, -1, -1, -1},
};
...
static struct ft5x0x_ts_platform_data ft5x0x_data = {
	...
	.gpio_irq = IVY_TOUCH_INT,
	.gpio_reset = IVY_TOUCH_REST,

	.ft5x0x_touchkey_map = ft5x0x_touchkey_map,
};

static struct goodix_touchkey goodix_touchkey_map[] = {
	{KEY_BACK, 0x1, 1018, 145},
	{KEY_HOME, 0x2, 1018, 315},
	{KEY_MENU, 0x4, 1018, 475},
	{-1, -1, -1, -1},
};

static struct goodix_i2c_platform_data goodix_data = {
	.touch_max_height = 7580,
	.touch_max_width = 5060,
	...
	.goodix_touchkey_map = goodix_touchkey_map,
};

static struct kxtf9_platform_data kxtf9_data = {
	.min_interval   = 1,
	.poll_interval  = 10,
...
static struct i2c_board_info mxc_i2c0_board_info[] __initdata = {
	...
	//.irq  = IOMUX_TO_IRQ_V3(IVY_G_SENSOR_INT),
	},
	{	/* compass */
	.type = "hmc5883",
	.addr = 0x1e,
	.platform_data = &hmc5883_data,
	.irq  = IOMUX_TO_IRQ_V3(IVY_COMPASS_INT),
	}, 
...
static struct i2c_board_info mxc_i2c1_board_info[] __initdata = {
	...
	{	/* FT5x0x touch */
		...
		.irq  = IOMUX_TO_IRQ_V3(IVY_TOUCH_INT),
	},
	{	/* GT801 touch */
		.type = "Goodix-TS",
		.addr = 0x55,
...
static unsigned int sdhc_get_card_det_status(struct device *dev)
{
	...
	if (to_platform_device(dev)->id == 0) {
		ret = gpio_get_value(IVY_SD_MMC_SD);
		return ret;
...
static int mx51_wifi_power(int on)
{
	...
	if(on) {
		gpio_set_value(IVY_WL_RST, 1);
	} else {
		gpio_set_value(IVY_WL_RST, 0);
	}
	return 0;
}
...
static struct resource mx51_wifi_resources[] = {
	[0] = {
		...
		.start =  IOMUX_TO_IRQ_V3(IVY_WLAN_WAKEUP_HOST),
		.end   =  IOMUX_TO_IRQ_V3(IVY_WLAN_WAKEUP_HOST),
...
{
	gpio_set_value(IVY_MIC_S, enable ? 0 : 1);
	return 0;
}

static int mxc_sgtl5000_amp_enable(int enable)
{
	gpio_set_value(IVY_AMP_SHUT, enable);
	return 0;
}

static int mxc_sgtl5000_finit(void)
{
	printk(KERN_INFO "ivy mxc_sgtl5000_finit: shutdown amp\n");
	gpio_set_value(IVY_AMP_SHUT, 0);
	return 0;
}

static int headphone_det_status(void)
{
	return (gpio_get_value(IVY_HPHONE_DET) == 1);
}
...
static struct mxc_audio_platform_data sgtl5000_data = {
	...
	.src_port = 2,
	.ext_port = 3,
	.hp_irq = IOMUX_TO_IRQ_V3(IVY_HPHONE_DET),
...
static int ivy_chg_is_cable_in(void)
{
	return gpio_get_value(IVY_AC_IN) ? 0 : 1;
}

static int ivy_is_charge_ok(void)
{
	return gpio_get_value(IVY_CHG_OK) ? 0 : 1;
}

static unsigned int ivy_get_bat_capacity(void)
{
	return 50;
}
...
static unsigned int ivy_get_bat_voltage(void)
{
...
static unsigned int ivy_get_bat_current(void)
{
	unsigned short result[8];
...
static struct mc13892_power_supply_pdata mc13892_psy_data = {
	.is_cable_in = ivy_chg_is_cable_in,
	.is_charge_ok = ivy_is_charge_ok,
	.get_bat_capacity = ivy_get_bat_capacity,
	.get_bat_voltage = ivy_get_bat_voltage,
	.get_bat_current = ivy_get_bat_current,
};
...
{
	printk(KERN_DEBUG "ivy: bt power %d\n", on);

	gpio_request(IVY_BT_RST, "bt_reset");
	if (on) {
		gpio_direction_output(IVY_BT_RST, 1);
	} else {
		gpio_direction_output(IVY_BT_RST, 0);
	}
	gpio_free(IVY_BT_RST);
...
static struct resource mx51_bluesleep_resources[] = {
	[0] = {
		.name  = "gpio_host_wake",
		.start = IVY_BT_WAKEUP_HOST,
		.end   = IVY_BT_WAKEUP_HOST,
		.flags = IORESOURCE_IO,
	},

	[1] = {
		.name  = "bt_wakeup",
		.start =  IVY_HOST_WAKEUP_BT,
		.end   =  IVY_HOST_WAKEUP_BT,
		.flags = IORESOURCE_IO,
	},

	[2] = {
		.name  = "bt_wakeup_host",
		.start =  IOMUX_TO_IRQ_V3(IVY_BT_WAKEUP_HOST),
		.end   =  IOMUX_TO_IRQ_V3(IVY_BT_WAKEUP_HOST),
				   ...
				   char **cmdline, struct meminfo *mi)
{
	...
	get_cpu_wp = mx51_ivy_get_cpu_wp;
	set_num_cpu_wp = mx51_ivy_set_num_cpu_wp;
	get_dvfs_core_wp = mx51_ivy_get_dvfs_core_table;
...
static void mxc_power_off(void)
{
	...
	gpio_direction_output(IVY_SYS_ON_OFF_CTL, 0);
	gpio_set_value(IVY_SYS_ON_OFF_CTL, 0);
}
...
static irqreturn_t power_key_int(int irq, void *dev_id)
{
	...
	if (gpio_get_value(IVY_SYS_ON_OFF_REQ))
...
static void mxc_register_powerkey(pwrkey_callback pk_cb)
{
	...
	int irq, ret;
	irq = IOMUX_TO_IRQ_V3(IVY_SYS_ON_OFF_REQ);
...
{
	return gpio_get_value(IVY_SYS_ON_OFF_REQ) ? 0 : 1;
}
...
{
	gpio_request(IVY_3G_RST, "3gmodem_reset");
	gpio_direction_output(IVY_3G_RST, 0);
	msleep(100);
	gpio_direction_output(IVY_3G_RST, 1);
	gpio_free(IVY_3G_RST);
...
{
	gpio_request(IVY_3G_PWR_EN, "3gmodem_pwr_en");
	gpio_request(IVY_3G_EN, "3gmodem_en");
	gpio_request(IVY_3G_RST, "3gmodem_reset");
	
	if (enable) {
		gpio_direction_output(IVY_3G_RST, 1);
		gpio_direction_output(IVY_3G_PWR_EN, 1);
		gpio_direction_output(IVY_3G_EN, 1);
	} else {
		gpio_direction_output(IVY_3G_PWR_EN, 0);
		gpio_direction_output(IVY_3G_EN, 0);
		gpio_direction_output(IVY_3G_RST, 0);
	}

	gpio_free(IVY_3G_PWR_EN);
	gpio_free(IVY_3G_EN);
	gpio_free(IVY_3G_RST);
...
{
	return gpio_get_value(IVY_3G_SIM_DET);
}

static struct modem_platform_data ivy_modem_platform =
{
	.sim_irq = -1,
	.wakeup_irq = -1,
	.is_sim_in = is_sim_in,
...
static struct platform_device ivy_3gmodem_device = {
	.name = "3Gmodem",
	.id = -1,
	.dev = {
		.platform_data = &ivy_modem_platform,
	},
};

/* For PCie interface modems */
static void modem_init(void)
{
	gpio_request(IVY_3G_EN, "modem off");
	gpio_direction_input(IVY_3G_EN);
	gpio_free(IVY_3G_EN);

	gpio_request(IVY_3G_SIM_DET, "sim_cd");
	gpio_direction_input(IVY_3G_SIM_DET);
	ivy_modem_platform.sim_irq = gpio_to_irq(IVY_3G_SIM_DET);

	if (platform_device_register(&ivy_3gmodem_device)) {
		pr_err("add 3G modem device failed\n");
		return;
	}
}

static void __init mx51_ivy_io_init(void)
{
	mxc_iomux_v3_setup_multiple_pads(mx51_ivy_pads, ARRAY_SIZE(mx51_ivy_pads));

	/* SYS_ON_OFF_CTRL */
	gpio_request(IVY_SYS_ON_OFF_CTL, "power_off");
	gpio_direction_output(IVY_SYS_ON_OFF_CTL, 1);
	gpio_set_value(IVY_SYS_ON_OFF_CTL, 1);
	
	/* SYS_ON_OFF_REQ */
	gpio_request(IVY_SYS_ON_OFF_REQ, "power_key");
	gpio_direction_input(IVY_SYS_ON_OFF_REQ);

	/* PMIC INT */
	gpio_request(IVY_INT_FROM_PMIC, "pmic_int");
	gpio_direction_input(IVY_INT_FROM_PMIC);

	/* SD1_CD SD1_WP */ 
	gpio_request(IVY_SD_MMC_SD, "sdhc1_detect");
	gpio_direction_input(IVY_SD_MMC_SD);
	gpio_request(IVY_SD1_WP, "sdhc1_wp");
	gpio_direction_input(IVY_SD1_WP);

	/* De-assert USB PHY RESETB */
	gpio_request(IVY_RST_USB_PHY_B, "usb_phy_reset");
	gpio_direction_output(IVY_RST_USB_PHY_B, 1);

	/* RST_USB_HUB_B */
	gpio_request(IVY_RST_USB_HUB_B, "rst_usb_hub");
	gpio_direction_output(IVY_RST_USB_HUB_B, 0);
	gpio_set_value(IVY_RST_USB_HUB_B, 0);
	msleep(1);
	gpio_set_value(IVY_RST_USB_HUB_B, 1);

	/* cap touch */
	gpio_request(IVY_TOUCH_INT, "touch_int");
	gpio_direction_input(IVY_TOUCH_INT);

	/* Camera module enable */
	gpio_request(IVY_CSI1_PWDN, "camera_enable");
	gpio_direction_output(IVY_CSI1_PWDN, 0);
	gpio_set_value(IVY_CSI1_PWDN, 1);

	/* IVY_VCAM_EN */
	gpio_request(IVY_VCAM_EN, "vcam_en");
	gpio_direction_output(IVY_VCAM_EN, 1);

	/* gsensor int */
	gpio_request(IVY_G_SENSOR_INT, "gsensor_int");
	gpio_direction_input(IVY_G_SENSOR_INT);

	/* WL_BT_PWR_EN */
	gpio_request(IVY_WL_BT_PWR_ON, "wl_bt_on");
	gpio_direction_output(IVY_WL_BT_PWR_ON, 1);

	/* WL_RST */
	gpio_request(IVY_WL_RST, "wl_rst");
	gpio_direction_output(IVY_WL_RST, 0);

	/* compass int */
	gpio_request(IVY_COMPASS_INT, "compass_int");
	gpio_direction_input(IVY_COMPASS_INT);

	/* VIBRATOR ON*/
	gpio_request(IVY_VIBRATOR_ON, "vibrator_on"); /* driver to low or high ?*/
	gpio_direction_output(IVY_VIBRATOR_ON, 0);

	/* Charger detect */
	gpio_request(IVY_AC_IN, "charger_det");
	gpio_direction_input(IVY_AC_IN);

	/* low battery wake up */
	gpio_request(IVY_LOW_BAT_WAKEUP, "low_bat_wakeup");
	gpio_direction_input(IVY_LOW_BAT_WAKEUP);

	/* Charger charge status */
	gpio_request(IVY_CHG_OK, "charge_ok");
	gpio_direction_input(IVY_CHG_OK);

	gpio_request(IVY_EIM_A16, "eim_a16");
	gpio_direction_output(IVY_EIM_A16, 1);
	gpio_request(IVY_EIM_A17, "eim_a17");
	gpio_direction_output(IVY_EIM_A17, 1);

	/* hphone_det_b */
	gpio_request(IVY_HPHONE_DET, "hphone-det");
	gpio_direction_input(IVY_HPHONE_DET);

	/* audio hphone mic control pin */
	gpio_request(IVY_MIC_S, "hphone_mic");
	gpio_direction_output(IVY_MIC_S, 1);
	gpio_set_value(IVY_MIC_S, 0);

	/* LCD related gpio, initialized on boot loader, keep no touch */
	gpio_request(IVY_LCD_STBYB, "lcd_stand_by");
	//gpio_direction_output(IVY_LCD_STBYB, 1);
	gpio_request(IVY_LCD_PWR_ON, "lcd_power_on");
	//gpio_direction_output(IVY_LCD_PWR_ON, 1);

	/* LVDS related gpio */
	gpio_request(IVY_LVDS_SHTDN, "lvds_power");
	//gpio_direction_output(IVY_LVDS_SHTDN, 0);
	gpio_request(IVY_LVDS_RSVD, "lvds_rsvd");
	gpio_direction_output(IVY_LVDS_RSVD, 0);

	/* LCD pwm out pin */
	gpio_request(IVY_PWM1_OUT, "pwm1_out");
	gpio_direction_output(IVY_PWM1_OUT, 0);
	...
	gpio_request(IVY_BT_WAKEUP_HOST, "bt_wakeup_host");
	gpio_direction_input(IVY_BT_WAKEUP_HOST);
	gpio_free(IVY_BT_WAKEUP_HOST);

	gpio_request(IVY_HOST_WAKEUP_BT, "bt_wakeup");
	gpio_direction_output(IVY_HOST_WAKEUP_BT, 1);
	gpio_free(IVY_HOST_WAKEUP_BT);

	/* GPS Power on*/
	gpio_request(IVY_GPS_PWR_ON, "gps_pwr_on");
	gpio_export(IVY_GPS_PWR_ON, 1);
	gpio_direction_output(IVY_GPS_PWR_ON, 0);
	
	/* GPS Reset */
	gpio_request(IVY_GPS_RST, "gps_reset");
	gpio_export(IVY_GPS_RST, 1);
	gpio_direction_output(IVY_GPS_RST, 1);

	/* Low_P_EN pin */
	gpio_request(IVY_LOW_P_EN, "low_p_en");
	gpio_direction_output(IVY_LOW_P_EN, 0);

	/* 26M osc en pin */
	gpio_request(IVY_26M_OSC_EN, "26M_osc");
	gpio_direction_output(IVY_26M_OSC_EN, 1);
}

/* workaround DC/DC TPS65251 low power control, shall move to PMIC_STBY_REQ */
void mx51_ivy_workaround_tps65251_low_power_mode(int low_power)
{
	printk(KERN_DEBUG "IVY low power mode %d\n", low_power);
	if (low_power) {
		gpio_direction_output(IVY_26M_OSC_EN, 0);
		gpio_set_value(IVY_LOW_P_EN, 1);
	} else {
		gpio_set_value(IVY_LOW_P_EN, 0);
		gpio_direction_output(IVY_26M_OSC_EN, 1);
	}
}
...
static void __init mxc_board_init(void)
{
	...
	/* SD card detect irqs */
	mxcsdhc1_device.resource[2].start = IOMUX_TO_IRQ_V3(IVY_SD_MMC_SD);
	mxcsdhc1_device.resource[2].end = IOMUX_TO_IRQ_V3(IVY_SD_MMC_SD);
	...
	pm_enter_standby_misc_setting = mx51_ivy_workaround_tps65251_low_power_mode;

	if (cpu_is_mx51_rev(CHIP_REV_1_1) == 2) {
		sgtl5000_data.sysclk = 26000000;
	}
	/* EIM_A23: audio amp shut pin */
	gpio_request(IVY_AMP_SHUT, "amp_shut"); /* ?????????????? is this audio standby? Driver to low? */
	gpio_direction_output(IVY_AMP_SHUT, 0);
	gpio_set_value(IVY_AMP_SHUT, 0);
...
#ifdef CONFIG_PM_CHECK
	register_gpio_setting(&ivy_gpio_check);
#endif
}

static void __init mx51_ivy_timer_init(void)
{
	struct clk *uart_clk;
...
static struct sys_timer mxc_timer = {
	.init	= mx51_ivy_timer_init,
};

/*
 * The following uses standard kernel macros define in arch.h in order to
 * initialize __mach_desc_MX51_IVY data structure.
 */
/* *INDENT-OFF* */
MACHINE_START(MX51_IVY, "Ivy Freescale MX51 Board")
